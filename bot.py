...
(
    ...
    ADD_SPONSOR_PHOTO, ADD_SPONSOR_NAME, ADD_SPONSOR_URL,
) = range(14)
...
async def add_sponsor_url(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    sponsor_id = db.add_sponsor(photo_file_id=ns["photo_file_id"], name=ns.get("name"), url=ns.get("url"))
...
def main():
    ...
    settings_conv = ConversationHandler(
        entry_points=[
            ...
            CallbackQueryHandler(settings_callback, pattern="^settings_|^delconfirm_|^sponsor"),
        ],
        states={
            ADD_NAME: [

...
async def get_index(request):
    """Sajikan index.html langsung di root domain, supaya URL Railway ini bisa
    dibuka langsung lewat browser biasa (bukan cuma lewat tombol Mini App di
    Telegram). Tanpa route eksplisit ini, aiohttp static TIDAK otomatis
    menyajikan index.html untuk path '/' -- cuma akan 403/404."""
...
def create_app():
    ...
    # perlu publik (index.html, bgm.mp3) yang disajikan lewat route eksplisit
    # di atas.
    return app

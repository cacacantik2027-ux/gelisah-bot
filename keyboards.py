...
def group_start_keyboard(user_id):
    ...
    tidak bisa dipakai/dibajak member lain di grup itu."""
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🚀 Mulai", callback_data=f"groupstart_{user_id}", style=STYLE_SUCCESS)],
    ])

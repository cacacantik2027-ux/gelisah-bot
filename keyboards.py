...
def talent_carousel_keyboard(talent, index, total):
    ...
    # Tombol penghitung halaman ("2/5") sengaja TIDAK diberi warna -- ini cuma
    # indikator posisi (callback_data="menu_noop", tidak melakukan apa-apa
    # saat ditekan), bukan aksi sungguhan, jadi dibiarkan netral supaya tidak
    # menyesatkan seolah-olah bisa "diklik" seperti tombol berwarna lainnya.
    nav_row.append(

...
def generate_watermark_only(width: int, height: int, opacity: float = 0.50) -> bytes:
    ...
    tersimpan sendirian, jelas kelihatan sebagai watermark, bukan cuma
    gambar kosong/blur yang membingungkan. Kalau proses gagal, balikin PNG
    transparan kosong 1x1 sebagai fallback paling aman."""
    try:
